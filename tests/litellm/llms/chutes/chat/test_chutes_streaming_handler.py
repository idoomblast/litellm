...
class TestChutesChatCompletionStreamingHandler:
    ...
    def test_buffering_partial_tokens(self):
        ...
        assert (
            result1.choices[0].delta.tool_calls is None
            or len(result1.choices[0].delta.tool_calls) == 0
        )
            ...
            "choices": [
                {
                    "index": 0,
                    "delta": {
                        "content": "<think>Let me analyze this request</think>Here is my answer"
                    },
                    "finish_reason": "stop",
                }
            ],
