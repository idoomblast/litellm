...
def test_build_vertex_schema_empty_properties():
    ...
    # Verify type is SET to "object" (Gemini requires type: object even without properties)
    assert go_back_schema.get("type") == "object", "Type should be 'object' when properties is empty"
